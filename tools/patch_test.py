#!/usr/bin/env python
# Example usage:  python patch_test.py <patch size> <resize>
def main():
  import os, sys, subprocess
  sys.path.append("/opt/fast-rcnn/caffe-fast-rcnn/python")
  import caffe
  #=================================================================
  ...
  #=================================================================
  os.chdir('/opt/fast-rcnn/models/CaffeNet/oirds/')
  network = 'train_val_'+patch_size+'.prototxt'
  with open('single_train_val2.prototxt', 'r') as f:
  ...
  with open('single_solver2.prototxt', 'r') as g:
