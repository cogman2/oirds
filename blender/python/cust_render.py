...
truck_object_y_rot=car_object.rotation_euler[1]
truck_object_x_rot=car_object.rotation_euler[0]
...
truck_object_z_rot=placement[0]
...
bpy.data.scenes["Scene"].render.filepath = 'newimg'
