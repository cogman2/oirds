...
model_def = caffe_root + 'faster_models/pascal_voc/ZF/faster_rcnn_end2end/deploy.prototxt'
model_weights = caffe_root + 'data/faster_rcnn_models/ZF_faster_rcnn_final.caffemodel'
